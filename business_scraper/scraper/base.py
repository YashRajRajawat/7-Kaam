...
from utils.paths import default_chrome_profile_dir
...
class BaseScraper(ABC):
    ...
    def start_browser(self) -> None:
        ...
        # The profile location is discovered from the environment rather than
        # hard-coded, and an absent profile simply means stealth-only mode.
        ...
        if chrome_src:
            ...
            self.logger.info("[BaseScraper] No Chrome profile found — stealth-only mode.")
